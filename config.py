blocked = "bot not working, error"#message that would be displayed if user has blocked you
start = "Hi! Send message to me, and I will FORWARD to Owner/Admin!"#start command
ban = "Banned! " #ban message
